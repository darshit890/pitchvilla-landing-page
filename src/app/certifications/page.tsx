    ...
    <div className="min-h-screen bg-gradient-to-bl from-[#44106C] via-[#6708A6] to-[#D007AC] overflow-hidden relative">
      ...
      <div className="container mx-auto px-6 pt-20 pb-12 relative z-10">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl text-white font-bold leading-tight tracking-tight max-w-4xl">
          Get Your Business <span className="text-pink-300">Certified</span> & <span className="text-pink-300">Recognized</span>
        </h1>
        
        <p className="mt-6 text-lg md:text-xl text-white/80 leading-relaxed font-light max-w-2xl">
          Professional certification services to enhance your business credibility and open new opportunities.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
          <div className="bg-white/10 backdrop-blur-md rounded-3xl p-6 border border-white/20">
            ...
            <h3 className="text-2xl font-bold text-white mb-3">ISO Certification</h3>
            <p className="text-white/70 mb-4">International quality management system certification.</p>
          ...
          <div className="bg-gradient-to-br from-[#6500AB]/90 to-[#D007AC]/50 backdrop-blur-md rounded-3xl p-8 border border-pink-500/30 relative">
            ...
            <h3 className="text-2xl font-bold text-white mb-3">Complete Certification Package</h3>
            <p className="text-white/70 mb-4">Comprehensive certification solutions for your business.</p>
            <ul className="space-y-2 mb-6">
              <li className="flex items-center text-white/80 text-sm">
                <CheckCircle className="h-4 w-4 text-pink-400 mr-2" />
                ISO certification
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-3xl p-6 border border-white/20">
            ...
            <p className="text-white/70 mb-4">Specialized certifications for your industry.</p>
            <ul className="space-y-2 mb-6">
              <li className="flex items-center text-white/80 text-sm">
                <CheckCircle className="h-4 w-4 text-pink-400 mr-2" />
                Industry analysis
      ...
      <div className="container mx-auto px-6 py-16 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Why Get Certified With Us</h2>
          <p className="text-white/70 text-lg max-w-2xl mx-auto">Expert guidance through every step of the certification process.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col items-center text-center p-6">
            ...
            <p className="text-white/70">Quick turnaround time for certification process.</p>
          </div>
          ...
          <div className="flex flex-col items-center text-center p-6">
            ...
            <p className="text-white/70">Dedicated team of certification specialists.</p>
          </div>
          
          <div className="flex flex-col items-center text-center p-6">
            <div className="h-16 w-16 bg-white/10 rounded-full flex items-center justify-center mb-5">
              <Certificate className="h-8 w-8 text-pink-400" />
            </div>
            <h3 className="text-xl font-bold text-white mb-3">Global Recognition</h3>
            <p className="text-white/70">Internationally recognized certifications.</p>
          </div>
        </div>
      </div>
